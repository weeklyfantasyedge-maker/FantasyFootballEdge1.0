...
/* ==========================================================
   BOARD DATA
   These are DEMO players and scores. Replace this list each
   week (or later, load it from a data feed).
   edge = 0 to 100. gap = projected points vs. consensus.
   ========================================================== */

type Pos = "QB" | "RB" | "WR" | "TE";
type Call = "Start" | "Flex" | "Sit";
...
const CALL_COLOR: Record<Call, string> = {
  Start: "#39ff5a",
  Flex: "#ffc23d",
  Sit: "#ff5a4f",
};

function callFor(edge: number): Call {
...
const FACTORS = [
  { letter: "E", title: "Efficiency", text: "How many points he produces per opportunity, adjusted for who he did it against." },
  { letter: "D", title: "Deployment", text: "Snaps, routes, carries, targets, and red-zone work. Role is the most stable signal in fantasy." },
  { letter: "G", title: "Game environment", text: "Spread, game total, pace, and weather. Points come from games that produce plays." },
  { letter: "E", title: "Expected gap", text: "Where my number sits against the consensus. That difference is the edge." },
];
      ...
      <main id="top">
        ...
        <section id="board" className="section">
          <div className="wrap">
            <div className="board-head">
              <div>
                <h2 className="h2">Edge Board: Week {WEEK}</h2>
                <p className="lede">
            ...
            {rows.length === 0 ? (
              ...
              <ol className="board">
                {rows.map((p) => {
                  ...
                  return (
                    <li key={p.name} className="row" style={tone(CALL_COLOR[p.call])}>
                      ...
                      <div className="edge">
                        ...
                        <div className="edge-gap">
                          {p.gap > 0 ? "+" : ""}
                          {p.gap.toFixed(1)} pts vs. consensus
                        </div>
                      </div>
                    </li>
                  );
        ...
        <section id="method" className="section method">
          <div className="wrap">
            ...
            <p className="lede">
              Every player is scored on four things. The four scores blend into one
              number, and the call follows from it.
            </p>
